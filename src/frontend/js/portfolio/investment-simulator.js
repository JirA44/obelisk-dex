        ...
        overlay.innerHTML = `
            <div class="simulator-modal">
                <div class="simulator-header">
                    <h2>📊 ${typeof I18n !== 'undefined' && I18n.currentLang === 'fr' ? 'Simulateur d\'Investissement' : 'Investment Simulator'}</h2>
                    <p class="simulator-subtitle">${typeof I18n !== 'undefined' && I18n.currentLang === 'fr' ? 'Simulez vos rendements potentiels avant d\'investir' : 'Simulate your potential returns before investing'}</p>
                ...
                ${results.map((r, i) => `
                    <div class="bar-row">
                        ...
                        <div class="bar-container">
                            <div class="bar" style="width: ${(r.earnings / maxEarnings)}%"></div>
