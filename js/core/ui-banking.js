...
const BondsUI = {
    ...
    showInvestModal(productId) {
        ...
        // Check if wallet connected (multiple sources)
        const isWalletConnected = (
            (typeof window.isWalletConnected !== 'undefined' && window.isWalletConnected) || (typeof WalletManager !== 'undefined' && (WalletManager.isUnlocked || WalletManager.currentWallet)) ||
            (typeof window.walletAddress !== 'undefined' && window.walletAddress) ||
            (typeof WalletConnect !== 'undefined' && (WalletConnect.address || WalletConnect.connected)) ||
            (typeof window.ethereum !== 'undefined' && window.ethereum.selectedAddress) ||
            localStorage.getItem('obelisk_wallet') ||
            localStorage.getItem('metamask_connected')
        );

        if (!isWalletConnected) {
            ObeliskApp?.showNotification?.('Connectez votre wallet pour investir', 'warning');
