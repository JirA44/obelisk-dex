...
const Onboarding = {
    steps: [
        {
            ...
            description: 'The next generation decentralized exchange. Non-custodial, fast, and secure.',
            icon: '◈',
            action: null
        },
        {
            ...
            description: 'Link your wallet to start trading. We support MetaMask, WalletConnect, and more.',
            icon: '🦊',
        ...
        },
        {
            ...
            description: 'Browse 24+ trading pairs with real-time prices from multiple sources.',
            icon: '📈',
        ...
        },
        {
            ...
            description: 'Enter an amount, choose buy or sell, and execute your first trade.',
            icon: '💱',
        ...
        },
        {
            ...
            description: 'Stake tokens, invest in vaults, or set up auto-DCA for hands-free earning.',
            icon: '💰',
        ...
        },
        {
            ...
            description: 'Start trading and explore all features. Need help? Check our docs or join Discord.',
            icon: '🎉',
            action: 'finish'
        }
    ],
    ...
    showStep(index) {
        ...
        this.modal.innerHTML = `
            ...
            <div class="onboarding-actions">
                ${!isFirst ? `<button class="onboarding-btn secondary" onclick="Onboarding.prev()">Back</button>` : ''}
                ${step.optional ? `<button class="onboarding-btn secondary" onclick="Onboarding.next()">${step.skipText || 'Skip'}</button>` : ''}
                <button class="onboarding-btn primary" onclick="Onboarding.handleAction('${step.action || 'next'}')">
                    ${isLast ? 'Get Started' : step.action ? 'Continue' : 'Next'}
                </button>
            </div>
    ...
    complete() {
        ...
        if (typeof showNotification === 'function') {
            showNotification('Welcome to OBELISK! Explore and start trading.', 'success');
        }
    },
